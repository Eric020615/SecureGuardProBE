...
import { CreateParcelDto, GetParcelDetailsDto, GetParcelDto } from '../dto/parcel.dto'
import { FileService } from './file.service'
import { Parcels } from '../model/parcels.model'
...
export class ParcelService {
	...
	getParcelDetailsByIdService = async (parcelGuid: string) => {
		try {
			...
			const createdBy = await this.userService.safeGetUserEmail(parcel.createdBy)
			const updatedBy = await this.userService.safeGetUserEmail(parcel.updatedBy)
			if (parcel != null) {
				data = {
					parcelId: parcel.id,
					parcelGuid: parcel.guid,
